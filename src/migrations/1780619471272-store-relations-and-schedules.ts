...
export class StoreRelationsAndSchedules1780619471272 implements MigrationInterface {
  name = 'StoreRelationsAndSchedules1780619471272';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."store_schedules_day_of_week_enum" AS ENUM('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."stores_status_enum" AS ENUM('ACTIVE', 'INACTIVE')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."stores_payment_types_enum" AS ENUM('CASH', 'QR')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."stores_sale_types_enum" AS ENUM('WHOLESALE', 'RETAIL')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "public"."stores_sale_types_enum"`);
    await queryRunner.query(`DROP TYPE "public"."stores_payment_types_enum"`);
    await queryRunner.query(`DROP TYPE "public"."stores_status_enum"`);
    await queryRunner.query(`DROP TABLE "store_schedules"`);
    await queryRunner.query(
      `DROP TYPE "public"."store_schedules_day_of_week_enum"`,
    );
  }
}
